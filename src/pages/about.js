          ...
          <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
            <div className='col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8'>
              ...
              <p className='font-medium'>
                Hi, I am Steven, a web developer and UI/UX designer with a
                passion for creating accessible, functional, and user-centered
                digital experiences. With 5 years of experience in the
                accessibility, I am always looking for new and innovative ways
                to bring create accessible deliverables.
              </p>

              <p className='my-4 font-medium'>
                I believe that design is about more than just making things look
                pretty – it is about solving problems and creating intuitive,
                enjoyable experiences for all users.
              </p>
              <p className='font-medium'>
            ...
            <div className='col-span-2 flex flex-col items-end justify-between xl:col-span-8 xl:flex-row xl:items-center md:order-3'>
              <div className='flex flex-col items-end justify-center xl:items-center'>
                <span className='inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl'>
                  <AnimatedNumbers value={480} />+
                </span>
                <p className='text-2xl font-medium capitalize text-dark/75 dark:text-light/75 xl:text-center lg:text-center md:text-lg sm:text-base xs:text-sm '>
                  Coding Bootcamp Hours
                </p>
              </div>
              <div className='flex flex-col items-end justify-center xl:items-center'>
                <span className='inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl '>
